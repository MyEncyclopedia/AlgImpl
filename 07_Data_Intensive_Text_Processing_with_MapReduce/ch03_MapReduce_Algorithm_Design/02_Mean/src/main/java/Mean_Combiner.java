...
public class Mean_Combiner {
    ...
    public static class MeanMapper extends Mapper<Object, Text, Text, SumCount> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new Text(type), new SumCount((long)v, 1));
        }

    }

    public static class MeanCombiner extends Reducer<Text, SumCount, Text, SumCount> {
        ...
        public void reduce(Text key, Iterable<SumCount> values, Context context) throws IOException, InterruptedException {
            ...
            context.write(key, new SumCount(sum, count));
        }
    }
